 ...
 * @LastEditTime: 2019-09-06 17:11:33
  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="status_id" label="状态" width="80"></el-table-column>
        <el-table-column prop="type_id" label="类型" width="100"></el-table-column>
        <el-table-column prop="create_time" label="添加时间" width="160"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="230"
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.show">
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item label="类型:">
            <el-select v-model="form.type_id" placeholder="类型">
          ...
          <el-form-item prop="status_id" label="状态:">
            <el-select v-model.number="form.status_id" placeholder="状态">
