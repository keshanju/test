  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="class_name" label="分类名称" width="160"></el-table-column>
        <el-table-column prop="link_type" label="类型" width="100"></el-table-column>
        <el-table-column prop="is_show" label="状态" width="120"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="230"
      ...
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item label="链接类型:">
            <el-select v-model="form.link_type" placeholder="链接类型">
          ...
          <el-form-item prop="incomePayDes" label="网站名称:">
            <el-input type="text" v-model="form.name"></el-input>
          </el-form-item>

          <el-form-item prop="income" label="网站Logo:">
            <el-input type="text" v-model.number="form.logo"></el-input>
          </el-form-item>

          <el-form-item prop="income" label="网站地址:">
            <el-input type="text" v-model.number="form.url"></el-input>
          </el-form-item>

          <el-form-item prop="pay" label="状态:">
