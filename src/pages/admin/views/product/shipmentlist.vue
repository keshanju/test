 ...
 * @LastEditTime: 2019-09-06 17:07:20
  ...
  <div>
    ...
    <div class="box-toolbar">
      <el-button-group>
        ...
        <el-button class="filter-item" type="primary" icon="el-icon-plus" @click="onAddHandler">添加发货方式</el-button>
      </el-button-group>
    </div>
    <div class="box-query">
      <el-table
      ...
      <div class="form">
        ...
        >
          ...
          <el-form-item label="阶梯价格:">
            <el-input
              type="text"
              v-model="form.step_price"
            ></el-input>
          </el-form-item>
          <el-form-item label="适用于地区:">
            <el-input
              type="text"
              v-model="form.area_price"
            ></el-input>
          </el-form-item>
          <el-form-item label="免费地区:">
            <el-input
              type="text"
              v-model="form.area_free"
            ></el-input>
          </el-form-item>
...
<script lang="ts" src="./shipmentlistController.ts">
