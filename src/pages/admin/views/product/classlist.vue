 ...
 * @LastEditTime: 2019-09-20 10:14:17
  ...
  <div>
    ...
    <div class="box-search">
      <el-form v-model="formSearch" :inline="true" class="demo-form-inline" size="small">
        ...
        <el-form-item style="float:right;">
          <el-button type="primary" icon="el-icon-plus" @click="onAddHandler">添加分类</el-button>
        </el-form-item>
      </el-form>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="classname" label="显示" width="60">
          <template slot-scope="scope">{{scope.row.is_show}}</template>
        </el-table-column>
        <el-table-column prop="classname" label="推荐" width="60">
          <template slot-scope="scope">{{scope.row.is_recommond}}</template>
        </el-table-column>
        <el-table-column
          label="操作"
          align="center"
