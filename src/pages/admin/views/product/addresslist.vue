 ...
 * @LastEditTime: 2019-09-06 17:05:40
      ...
      <div class="form">
        ...
        >
          ...
          <el-form-item
            label="省份:"
          >
           <el-select v-model="form.area_pro" placeholder="选择省份">
              <el-option></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item
            ...
            label="市:"
          >
           <el-select v-model="form.area_city" placeholder="选择市">
              <el-option></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item
            ...
            label="县:"
          >
           <el-select v-model="form.area_city2" placeholder="选择县">
              <el-option></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="默认:">
               <el-checkbox
              :checked="form.is_default==1?true:false"
              @change="form.is_default=form.is_default==1?0:1"
            >是</el-checkbox>
          </el-form-item>
...
<script lang="ts" src="./addresslistController.ts">
