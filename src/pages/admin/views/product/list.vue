 ...
 * @LastEditTime: 2019-09-20 09:42:00
...
<template>
  <div>
      ...
      <el-form v-model="formSearch" :inline="true" class="demo-form-inline" size="small">
        <el-form-item label="类型：">
          <el-select
            ...
            @change="onSearchForm(formSearch)"
          >
            <el-option
              :label="item.name"
              :value="item.id"
    ...
    <div class="box-toolbar">
      <el-button-group>
        ...
        <el-button
          ...
          type="primary"
          size="small"
          @click="batImportProductHandler"
        >批量上传</el-button>
      </el-button-group>
      <el-button-group style="float:right;">
        <el-button class="filter-item" type="primary" icon="el-icon-plus" @click="onAddHandler">添加产品</el-button>
      </el-button-group>
    </div>
    <div class="box-query">
      <el-table
      ...
      >
        ...
        <el-table-column prop="market_price" label="图片" width="200"></el-table-column>
        <el-table-column prop="market_price" label="市场价" width="80"></el-table-column>
        <el-table-column prop="member_price" label="会员价" width="80"></el-table-column>
        <el-table-column prop="stock_count" label="库存" width="80"></el-table-column>
        <el-table-column prop="stock_count" label="销售量" width="80"></el-table-column>
        <el-table-column prop="stock_count" label="状态" width="80"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="230"
    ...
    <el-dialog :title="dialog_bat_import.title" :visible.sync="dialog_bat_import.show">
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item label="选择文件:">
            ...
            <el-col :span="4">
              <a href="./product/product.csv" style="color:blue">下载Excel模板</a>
            </el-col>
          </el-form-item>
          <el-form-item class="text_right">
            <el-button type="primary" @click="onSubmitHandler('form')">导 入</el-button>
            <el-button @click="dialog_bat_import.show = false">取 消</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-dialog>
