  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="classname" label="分类名称" width="160"></el-table-column>
        <el-table-column prop="template" label="模板文件" width="160"></el-table-column>
        <el-table-column prop="is_footer" label="底部导航" width="100" align="center">
          <template slot-scope="scope">
              <div v-if="scope.row.is_footer==1" style="color:red">
                是
              </div>
              <div v-else>
                否
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.show">
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item prop="incomePayDes" label="标题:">
            <el-input type="text" v-model="form.title"></el-input>
          </el-form-item>

          <el-form-item label="所属分类:">
            <el-select v-model="form.classid" placeholder="所属分类">
          ...
          <el-form-item prop="income" label="模板文件:">
            <el-input type="income" v-model="form.template"></el-input>
          </el-form-item>

          <el-form-item prop="pay" label="是否页脚:">
            <el-switch v-model="form.is_footer"></el-switch>
          </el-form-item>

          <el-form-item prop="accoutCash" label="页面关键词:">
            <el-input type="accoutCash" v-model.number="form.keywords"></el-input>
          </el-form-item>
