 ...
 * @LastEditTime: 2019-09-06 17:07:58
  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="user_name" label="评论者" width="60"></el-table-column>
        <el-table-column prop="id" label="状态" width="60"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="230"
      ...
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item label="管理员回复:">
            <el-input type="textarea" v-model="form.replay_content"></el-input>
          </el-form-item>

          <el-form-item label="回复状态:">
            <el-select v-model="form.is_show" placeholder="回复状态">
...
<script lang="ts" src="./commentlistController.ts">
</script>