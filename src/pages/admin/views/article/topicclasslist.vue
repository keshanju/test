 ...
 * @LastEditTime: 2019-09-20 14:36:07
      ...
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item label="网站关键词:">
            <el-input type="textarea" v-model="form.class_keyword"></el-input>
          </el-form-item>
          <el-form-item label="网站说明:">
            <el-input type="textarea" v-model="form.class_description"></el-input>
          </el-form-item>
          <el-form-item label="分类描述:">
            <el-input type="textarea" v-model="form.readme"></el-input>
          </el-form-item>
          <el-form-item label="首页模板:">
            <el-input type="text" v-model="form.template_index"></el-input>
          </el-form-item>
