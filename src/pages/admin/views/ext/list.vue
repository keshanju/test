 ...
 * @LastEditTime: 2019-09-06 17:10:53
  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="author" label="字段类型" width="60"></el-table-column>
        <el-table-column prop="hits" label="创建时间" width="60"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="230"
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.show">
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item prop="incomePayDes" label="字段名称:">
            <el-input type="text" v-model="form.name"></el-input>
          </el-form-item>

          <el-form-item prop="incomePayDes" label="是否多选:">
            <el-input type="text" v-model="form.is_choice"></el-input>
          </el-form-item>

          <el-form-item prop="incomePayDes" label="是图片:">
            <el-input type="text" v-model="form.is_use_img"></el-input>
          </el-form-item>

          <el-form-item prop="incomePayDes" label="字段默认值:">
            <el-input type="text" v-model="form.content"></el-input>
          </el-form-item>

          <el-form-item label="排序:">
            <el-select v-model="form.order_id" placeholder="收支类型">
