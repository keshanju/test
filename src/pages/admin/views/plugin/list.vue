 ...
 * @LastEditTime: 2019-09-06 17:12:16
  ...
  <div>
    ...
    <div class="box-query">
      ...
      >
        ...
        <el-table-column prop="desc" label="说明" width="60"></el-table-column>
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.show">
      <div class="form">
        <el-form ref="form" :model="form" label-width="120px">
          <el-form-item prop="incomePayDes" label="上传模板包:">
            <el-input type="text" v-model="form.incomePayDes"></el-input>
          </el-form-item>

          <el-form-item class="text_right">
            <el-button type="primary" @click="onSubmitHandler('form')">开始导入</el-button>
