...
export class FileApi extends BaseApi {
    ...
    public async getListPager(strWhere: string = "", pageSize: number = 15, pageIndex: number = 1) {
        let url: string = "/api/admin/file?token=" + this.token + "&page_size=" + pageSize + "&start_index=" + pageIndex + strWhere;
    ...
    public async getList(strWhere: string = "") {
        let url: string = "/api/admin/file/list?token=" + this.token;
    ...
    public async setAdd(data: ExtModel) {
        let url = "/api/admin/file"+"?token="+this.token;
    ...
    public async setUpdate(id: number, data: ExtModel) {
        let url = "/api/admin/file/" + id+"?token="+this.token;
