 ...
 * @LastEditTime: 2019-09-20 16:44:25
...
export default class BaseVue extends Vue {
   ...
   */
  public validateForm(refFormName: string = "form", callback: () => Promise<BaseResult>, callback_result: (flag: boolean) => void = null) {
   ...
   * 数据删除
   */
  public dataDelete(callback: () => Promise<BaseResult>, callback_result: (flag: boolean) => void = null) {
