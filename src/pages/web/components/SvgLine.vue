<template>
  <svg :style="{ height: opts.height + 'px', width: opts.width + 'px' }">
    ...
    <polyline fill="none" :points="polylinePoints" :stroke="sColor" :stroke-width="opts.strokeWidth" stroke-linecap="square"></polyline>
  </svg>
</template>
<script>
export default {
  ...
  created: function () {
    this.opts.width = this.width || 150;
    this.opts.height = this.height || 60;
