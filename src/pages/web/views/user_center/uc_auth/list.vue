        ...
        <div class="auth_form_box">
          <el-card class="auth_form_cell" shadow="hover">
            <el-form :model="authForm" :rules="authRules" label-width="100px" label-position="left" ref="authForm" class="mar_t20">
                <el-form-item prop="phoneNumber" label="国籍:" v-if="stepNum === 1">
                ...
                <el-form-item prop="captcha" label="证件类型:" v-if="stepNum === 1">
                  <el-select style="width: 100%" v-model="authForm.idType" placeholder="请选择">
                    <el-option label="身份证" value="1"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item prop="idNumber" label="证件号码:" v-if="stepNum === 1">
                  <el-input placeholder="请输入" show-password v-model="authForm.idNumber"></el-input>
                </el-form-item>
                <el-form-item prop="name" label="姓名:" v-if="stepNum === 1">
                  <el-input placeholder="请输入" show-password v-model="authForm.name"></el-input>
                </el-form-item>

                
                <el-form-item prop="cardFront" v-if="stepNum === 2">
                  <el-upload
                    drag
                ...
                <el-form-item prop="cardReverse" v-if="stepNum === 2">
                  <el-upload
                    drag
                    action="https://jsonplaceholder.typicode.com/posts/"
                    multiple>
                ...
                <el-form-item prop="cardholdCardFront" v-if="stepNum === 2">
                  <el-upload
                    drag
                    action="https://jsonplaceholder.typicode.com/posts/"
                    multiple>
